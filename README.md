...
```sh
npm install https://github.com/anyoszoli-glitch/commspliant-editor/releases/download/v0.5.0/commspliant-tili-toli-editor-0.5.0.tgz
```

The repository tag can also be installed directly:

```sh
npm install github:anyoszoli-glitch/commspliant-editor#v0.5.0
```
