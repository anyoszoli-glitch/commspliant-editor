...
```sh
npm install https://github.com/anyoszoli-glitch/commspliant-editor/releases/download/v0.6.0/commspliant-tili-toli-editor-0.6.0.tgz
```

The repository tag can also be installed directly:

```sh
npm install github:anyoszoli-glitch/commspliant-editor#v0.6.0
```
...
`PagedDocumentLayout.pageSettings` optionally stores custom margins for individual rendered
pages. Each setting is attached to a stable content or page-break anchor, so inserting or
